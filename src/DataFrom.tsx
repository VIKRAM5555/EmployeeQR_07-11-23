...
const MyForm: React.FC = () => {
  ...
  let datastatus: any = MyDocumentList(
    localStorage,
    "NewDoctypefromOld"
    // "user_image"
  );
  let employeestatus: any = MyDocumentList(
    localStorage,
    "Employee"
    // "user_image"
  );
  ...
  // let photo = employeestatus?.[0]?.user_image;
  // console.log(photo);
          ...
          >
            <ImageListItem
              sx={{
                width: "150px",
                height: "150px",
                display: "flex", // Set to flex to allow the images to be side by side
                flexDirection: "column", // Stack images in a column
