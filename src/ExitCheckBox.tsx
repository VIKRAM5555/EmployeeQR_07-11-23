...
// import { GetDataPending } from "./GetData";
...
//   const dataPending: any = GetDataPending();

//   // const itemsArray = data?.map((item) => item.carry.split(", ")).flat();
//   const itemsArray = `${
//     (data?.[0]?.carry || "") +
//     (data?.[0] && dataPending?.[1] && ",") +
//     dataPending?.[1].unchecked
//   }`.split(",");
...
//     if (data || dataPending) {
//       setUncheckedlist(
//         [...itemsArray].filter((a, i) => itemsArray.indexOf(a) === i)
//       );
